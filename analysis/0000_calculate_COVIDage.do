********************************************************************************
*
*	Do-file:		0000_calculate_COVIDage.do
*
...
program define covidage
	...
	* Diabetes
	replace covid_age = covid_age + 24  if  diabcat==2 & inrange(age, 10, 25)
	replace covid_age = covid_age + 23  if  diabcat==2 & inrange(age, 26, 31)
	replace covid_age = covid_age + 22  if  diabcat==2 & inrange(age, 32, 36)
	replace covid_age = covid_age + 21  if  diabcat==2 & inrange(age, 37, 41)
	replace covid_age = covid_age + 20  if  diabcat==2 & inrange(age, 42, 46)
	replace covid_age = covid_age + 19  if  diabcat==2 & inrange(age, 47, 48)
	replace covid_age = covid_age + 18  if  diabcat==2 & inrange(age, 49, 51)
	replace covid_age = covid_age + 17  if  diabcat==2 & inrange(age, 52, 53)
	replace covid_age = covid_age + 16  if  diabcat==2 & inrange(age, 54, 56)
	replace covid_age = covid_age + 15  if  diabcat==2 & inrange(age, 57, 58)
	replace covid_age = covid_age + 14  if  diabcat==2 & inrange(age, 59, 60)
	replace covid_age = covid_age + 13  if  diabcat==2 & inrange(age, 61, 62)
	replace covid_age = covid_age + 12  if  diabcat==2 & inrange(age, 63, 64)
	replace covid_age = covid_age + 11  if  diabcat==2 & inrange(age, 65, 67)
	replace covid_age = covid_age + 10  if  diabcat==2 & inrange(age, 68, 70)
	replace covid_age = covid_age + 9   if  diabcat==2 & inrange(age, 71, 72)
	replace covid_age = covid_age + 8   if  diabcat==2 & inrange(age, 73, 110)

	replace covid_age = covid_age + 27  if  diabcat==3 & inrange(age, 10, 25)
	replace covid_age = covid_age + 26  if  diabcat==3 & inrange(age, 26, 31)
	replace covid_age = covid_age + 25  if  diabcat==3 & inrange(age, 32, 37)
	replace covid_age = covid_age + 24  if  diabcat==3 & inrange(age, 38, 42)
	replace covid_age = covid_age + 23  if  diabcat==3 & inrange(age, 43, 46)
	replace covid_age = covid_age + 22  if  diabcat==3 & inrange(age, 47, 49)
	replace covid_age = covid_age + 21  if  diabcat==3 & inrange(age, 50, 51)
	replace covid_age = covid_age + 20  if  diabcat==3 & inrange(age, 52, 53)
	replace covid_age = covid_age + 19  if  diabcat==3 & inrange(age, 54, 56)
	replace covid_age = covid_age + 18  if  diabcat==3 & inrange(age, 57, 58)
	replace covid_age = covid_age + 17  if  diabcat==3 & inrange(age, 59, 60)
	replace covid_age = covid_age + 16  if  diabcat==3 & inrange(age, 61, 62)
	replace covid_age = covid_age + 15  if  diabcat==3 & inrange(age, 63, 64)
	replace covid_age = covid_age + 14  if  diabcat==3 & inrange(age, 65, 67)
	replace covid_age = covid_age + 13  if  diabcat==3 & inrange(age, 68, 70)
	replace covid_age = covid_age + 12  if  diabcat==3 & inrange(age, 71, 73)
	replace covid_age = covid_age + 11  if  diabcat==3 & inrange(age, 74, 110)

	replace covid_age = covid_age + 29  if  diabcat==4 & inrange(age, 10, 24)
	replace covid_age = covid_age + 28  if  diabcat==4 & inrange(age, 25, 32)
	replace covid_age = covid_age + 27  if  diabcat==4 & inrange(age, 33, 37)
	replace covid_age = covid_age + 26  if  diabcat==4 & inrange(age, 38, 41)
	replace covid_age = covid_age + 25  if  diabcat==4 & inrange(age, 42, 45)
	replace covid_age = covid_age + 24  if  diabcat==4 & inrange(age, 46, 48)
	replace covid_age = covid_age + 23  if  diabcat==4 & inrange(age, 49, 51)
	replace covid_age = covid_age + 22  if  diabcat==4 & inrange(age, 52, 53)
	replace covid_age = covid_age + 21  if  diabcat==4 & inrange(age, 54, 55)
	replace covid_age = covid_age + 20  if  diabcat==4 & inrange(age, 56, 57)
	replace covid_age = covid_age + 19  if  diabcat==4 & inrange(age, 58, 59)
	replace covid_age = covid_age + 18  if  diabcat==4 & inrange(age, 60, 61)
	replace covid_age = covid_age + 17  if  diabcat==4 & inrange(age, 62, 63)
	replace covid_age = covid_age + 16  if  diabcat==4 & inrange(age, 64, 65)
	replace covid_age = covid_age + 15  if  diabcat==4 & inrange(age, 66, 67)
	replace covid_age = covid_age + 14  if  diabcat==4 & inrange(age, 68, 70)
	replace covid_age = covid_age + 13  if  diabcat==4 & inrange(age, 71, 72)
	replace covid_age = covid_age + 12  if  diabcat==4 & inrange(age, 73, 110)
