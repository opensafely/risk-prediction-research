********************************************************************************
*
*	Do-file:		1203_rp_b_validation_28day_sens.do
*
*	Programmed by:	Fizz & John & Krishnan
*
*	Data used:		data/cr_landmark.dta
*
*	Data created:	data/approach_b_1_sens
*					output/approach_b_validation_28day_sens.out
*
*	Other output:	Log file:  	output/1203_rp_b_validation_28day_sens.log
*
********************************************************************************
*
...
* Open a log file
capture log close
log using "./output/1203_rp_b_validation_28day", text replace
...
forvalues i = 1/3 {
	...
	**************************
	...
	postfile `measures' str5(approach) str30(prediction) str3(period)			///
		...
		using "data/approach_b_`i'_sens", replace
...
* Clean up
use "data/approach_b_1_sens", clear
forvalues i = 2(1)3 { 
	append using "data/approach_b_`i'_sens" 
	erase "data/approach_b_`i'_sens.dta" 
}
erase "data/approach_b_1_sens.dta" 
save "data/approach_b_validation_28day_sens.dta", replace 




* Export a text version of the output
use "data/approach_b_validation_28day_sens.dta", clear
outsheet using "output/approach_b_validation_28day_sens.out", replace
