********************************************************************************
*
*	Do-file:		905_rp_a_validation_28day_sens_agesex.do
*
...
*
*	Data created:	data/approach_a_validation_sens_agesex.dta
*					output/approach_a_validation_28day_sens_agesex.out
*
*	Other output:	Log file:  	output/905_rp_a_validation_28day_sens_agesex.log
*					
********************************************************************************
*
...
* Open a log file
capture log close
log using "./output/905_rp_a_validation_28day_sens_agesex", text replace
...
forvalues i = 1/3 {
	...
	**************************
	...
	postfile `measures' str5(approach) str30(prediction) str3(period)			///
		...
		using "data/approach_a_`i'_sens_agesex", replace
...
* Clean up
use "data/approach_a_1_sens_agesex", clear
forvalues i = 2(1)3 { 
	append using "data/approach_a_`i'_sens_agesex" 
	erase "data/approach_a_`i'_sens_agesex.dta" 
}
erase "data/approach_a_1_sens_agesex.dta" 
...
save "data/approach_a_validation_28day_sens_agesex.dta", replace 



* Export a text version of the output
use "data/approach_a_validation_28day_sens_agesex.dta", clear
outsheet using "output/approach_a_validation_28day_sens_agesex.out", replace
