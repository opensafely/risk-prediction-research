********************************************************************************
*
*	Do-file:			702_rp_cii_allcause_validation_intext.do
*
*	Written by:			Fizz
*
*	Data used:			data/cr_daily_landmark_noncovid.dta
*
*	Data created:		data/model_cii_allcause_`tvc'_`r'.dta
*							where tvc = foi, ae or susp.
*
*	Other output:		Log file:  	702_rp_cii_allcause_validation_intext_`tvc'.log
*						Estimates:	coefs_cii_allcause_`tvc'_`r'.ster
*
********************************************************************************
*
...
* Open a log file
capture log close
log using "./output/702_rp_cii_allcause_validation_intext_`tvc'", text replace
...
forvalues r = 1 (1) 8 {
	...
	*********************
	...
	capture erase output/models/coefs_cii_allcause_`tvc'_`r'.ster
	...
	* Fit model
	...
	estimates save output/models/coefs_cii_allcause_`tvc'_`r', replace
	...
	* Pick up coefficient matrix
	...
	get_coefs, coef_matrix(b) eqname("onsotherdeath:")  ///
		dataname("data/model_cii_allcause_`tvc'_`r'")
