********************************************************************************
*
*	Do-file:		204_rp_a_validation_28day_by_region.do
*
...
*						model_a_coxPH.dta
*
*	Data created:	data/approach_a_validation_by_region.dta
*					output/approach_a_validation_28day_by_region.out
*
*	Other output:	Log file:  	output/204_rp_a_validation_28day_by_region.log
*					
********************************************************************************
*
*	Purpose:		This do-file obtains calibration slopes and intercepts by
*					region for Design A models (as suggested by a reviewer).
*  
********************************************************************************
*	
...
forvalues i = 1/3 {
	...
	**************************
	...
	postfile `measures' str5(approach) region str30(prediction) str3(period)	///
		...
		using "data/approach_a_`i'_by_region", replace
...
* Clean up
use "data/approach_a_1_by_region", clear
forvalues i = 2(1)3 { 
	append using "data/approach_a_`i'_by_region" 
	erase "data/approach_a_`i'_by_region.dta" 
}
erase "data/approach_a_1_by_region.dta" 
save "data/approach_a_validation_28day_by_region.dta", replace 



* Export a text version of the output
use "data/approach_a_validation_28day_by_region.dta", clear
